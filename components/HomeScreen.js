  ...
  return (
    <View style={{backgroundColor: "black", width:"100%", height:"100%", padding:20, }}>
      ...
      <View style={{display:"flex", paddingVertical:5, flexDirection:"row", alignItems:"center", justifyContent:"space-between", width:"100%", gap: 30}}>
        <TouchableOpacity onPress={()=>{navigation.navigate('History')}} style={{ gap:10, borderRadius:20, backgroundColor:"green", display:"flex", justifyContent:"center", flexDirection:"row", alignItems:"center"}}>
            <Image source={require('../assets/History.png')} style={{width:"25%", height: 40}} resizeMode='contain' />
            <Text style={{color:"white"}}>History</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>{navigation.navigate('Favourites')}} style={{ gap:10, borderRadius:20, backgroundColor:"green", display:"flex", justifyContent:"center", flexDirection:"row", alignItems:"center"}}>
